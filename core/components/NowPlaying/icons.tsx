const SpotifyLogo = ({ colored = false }: { colored?: boolean }) => {
  return (
    <svg
      width="22"
      height="22"
    ...
    >
      <path
        ...
        fill={colored ? '#1ED760' : 'currentColor'}
      />
    </svg>
  );
};
  ...
  <>
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="var(--laodeaksar-colors-brand)" />
          <stop offset="1" stopColor="var(--laodeaksar-colors-foreground)" />
        </linearGradient>
      </defs>
    </svg>
    ...
    >
      ...
      <defs>
        ...
        >
          <stop
            stopColor="var(--laodeaksar-colors-foreground)"
            stopOpacity="0.65"
          />
          <stop
            offset="1"
            stopColor="var(--laodeaksar-colors-brand)"
            stopOpacity="0.17"
          />
        </radialGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="var(--laodeaksar-colors-brand)" stopOpacity="0.4" />
          <stop
            offset="1"
            stopColor="var(--laodeaksar-colors-foreground)"
            stopOpacity="0"
